...
import (
	...
	engine "github.com/rootbay/tenvy-client/internal/plugins/engines/appvnc"
	"github.com/rootbay/tenvy-client/internal/plugins/runner"
)

func main() {
	runner.Run(
		"appvnc-control-engine plugin",
		"appvnc-engine",
		func(logger *log.Logger) engine.Engine {
			return engine.NewAppVncEngine(engine.Config{Logger: logger})
		},
