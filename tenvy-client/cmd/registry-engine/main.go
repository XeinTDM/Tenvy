...
import (
	...
	engine "github.com/rootbay/tenvy-client/internal/plugins/engines/registry"
	"github.com/rootbay/tenvy-client/internal/plugins/runner"
)

func main() {
	runner.Run(
		"registry-control-engine plugin",
		"registry-engine",
		func(logger *log.Logger) engine.Engine {
			return engine.NewRegistryEngine(engine.Config{Logger: logger})
		},
