...
import (
	...
	engine "github.com/rootbay/tenvy-client/internal/plugins/engines/audio"
	"github.com/rootbay/tenvy-client/internal/plugins/runner"
)

func main() {
	runner.Run(
		"audio-control-engine plugin",
		"audio-engine",
		func(logger *log.Logger) engine.Engine {
			return engine.NewAudioEngine(engine.Config{Logger: logger})
		},
