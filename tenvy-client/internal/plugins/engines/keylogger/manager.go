...
type StartConfig struct {
	...
	CadenceMs          int  `json:"cadenceMs,omitempty" msgpack:"cadenceMs,omitempty"`
	BatchIntervalMs    int  `json:"batchIntervalMs,omitempty" msgpack:"batchIntervalMs,omitempty"`
	BufferSize         int  `json:"bufferSize,omitempty" msgpack:"bufferSize,omitempty"`
	IncludeWindowTitle bool `json:"includeWindowTitles,omitempty" msgpack:"includeWindowTitles,omitempty"`
	IncludeClipboard   bool `json:"includeClipboard,omitempty" msgpack:"includeClipboard,omitempty"`
	EmitProcessNames   bool `json:"emitProcessNames,omitempty" msgpack:"emitProcessNames,omitempty"`
	IncludeScreenshots bool `json:"includeScreenshots,omitempty" msgpack:"includeScreenshots,omitempty"`
	EncryptAtRest      bool `json:"encryptAtRest,omitempty" msgpack:"encryptAtRest,omitempty"`
	RedactSecrets      bool `json:"redactSecrets,omitempty" msgpack:"redactSecrets,omitempty"`
}
...
type CommandPayload struct {
	...
	Mode      Mode         `json:"mode,omitempty" msgpack:"mode,omitempty"`
	Config    *StartConfig `json:"config,omitempty" msgpack:"config,omitempty"`
}
...
func (m *Manager) requestTimeout() time.Duration {
	if cfg := m.config(); cfg.RequestTimeout > 0 {
